...
%>
            ...
            <main>
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-7 col-md-12">
                                        <div class="hero__caption">
                                            <h1 data-animation="fadeInLeft" data-delay="0.2s"> Deleted successfully roll <%out.println(request.getParameter("roll_number")); %> <br> </h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <%
                int roll=Integer.parseInt(request.getParameter("roll_number"));
            	try
            	{
            		Class.forName("com.mysql.cj.jdbc.Driver");
            		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/project" , "root" , "tiger");
            		Statement stmt = con.createStatement();
            		stmt.executeUpdate("DELETE FROM student WHERE roll_no ="+roll);
