...
%>
                                            ...
                                            <div class="main-menu d-none d-lg-block">
                                                <nav>
                                                    <ul id="navigation">
                                                        ...
                                                        <li> <a href="#">Faculty</a>
                                                            <ul class="submenu">
                                                                <li> <a href="admin_faculty_manage.jsp"> Manage </a> </li>
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-7 col-md-12">
                                        <div class="hero__caption">
                                            <h1 data-animation="fadeInLeft" data-delay="0.2s"> Manage Students <br> </h1>
                                            <p data-animation="fadeInLeft" data-delay="0.4s"> Delete Students from this page. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="progress-table-wrap">
                <div class="progress-table">
                    <form class="form-default" action="admin_faculty_delete.jsp" method="POST">
                        <div class="table-head">
                            <div class="name">name</div>
                            <div class="name">username</div>
                            <div class="name">email</div>
                            <div class="accept">Select Student</div>
                        </div>
		...
		try
		{
			...
			String sql = "SELECT * FROM project.faculty where is_approved=1;";
...
%>
                                <div class="table-row">
                                    ...
                                    <div class="accept"><input type="checkbox" name="username" value="<%= rs.getString("username")%>"></div>
                                </div>
                                <%
			}
...
%>
                                    <div class="form-input pt-30 request">
                                        <input class="genric-btn primary-border" type="submit" value="Delete">
                                    </div>
                    </form>
                </div>
            </div>
