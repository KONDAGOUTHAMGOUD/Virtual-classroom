...
%>
            ...
            <div class="progress-table-wrap">
                <div class="progress-table">
                    <form class="form-default" action="admin_student_delete.jsp" method="POST">
		...
		try
		{
			...
			String sql = "select * from student where is_approved = 1";
...
%>
                                <div class="table-row">
                                    ...
                                    <div class="accept"><input type="checkbox" name="roll_number" value="<%= rs.getString("roll_no")%>"></div>
                                </div>
                                <%
			}
